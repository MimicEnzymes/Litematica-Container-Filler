...
public class HighlightRenderer {
    ...
    private void drawMaterialFocusMarker(HighlightBox box, Vec3d cameraPos, double time, net.minecraft.client.render.BufferBuilder buffer) {
    ...
    private void drawWorldSquareRing(float cx, float y, float cz, float half, float thickness, Color4f color, Vec3d cameraPos, net.minecraft.client.render.BufferBuilder buffer) {
