...
public class HighlightRenderer {
    ...
    private void rebuildDirtyChunks(boolean xray, Vec3d cameraPos, MinecraftClient client) {
        int rebuilt = 0;
    ...
    private ChunkRenderCache buildChunkCache(Map<BlockPos, HighlightState> highlights, boolean xray, Vec3d cameraPos, MinecraftClient client) {
