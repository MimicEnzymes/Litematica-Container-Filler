...
public class ToolHudRenderer {
    ...
    private static float[] projectTarget(Minecraft client, BlockPos target, int width, int height) {
    ...
    private static void drawToolCard(GuiGraphicsExtractor context, Minecraft client, int x, int y, int width, int height, float scale, int alpha, float eased, boolean showProgress) {
    ...
    private static void drawHudToolIcon(GuiGraphicsExtractor context, int cx, int cy, float scale, int alpha, float eased, ContainerToolMode mode) {
    ...
    private static void drawScaledText(GuiGraphicsExtractor context, Minecraft client, String text, int x, int y, float scale, int color) {
    ...
    private static void fillRotatedPolygon(GuiGraphicsExtractor context, int cx, int cy, ArrowDirection direction, int color, int[] relXs, int[] relYs) {
    ...
    private static void fillPolygon(GuiGraphicsExtractor context, int[] xs, int[] ys, int color) {
