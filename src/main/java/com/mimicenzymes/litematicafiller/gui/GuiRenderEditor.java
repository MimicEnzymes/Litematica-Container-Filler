...
public class GuiRenderEditor extends GuiBase {
    ...
    private void drawHudToolWheelPreview(GuiContext context, ContainerToolMode mode, int panelX, int panelW,
    ...
    private void drawHudWheelPreviewRow(GuiContext context, ContainerToolMode mode, int iconX, int textX,
    ...
    private void drawScaledString(GuiContext context, String text, int x, int y, float scale, int color) {
